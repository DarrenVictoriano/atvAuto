class AppList:
    ...
    def __init__(self):
        ...
        self.PARENTAL_LOCK_PKG = "com.sony.dtv.tvsettingsbroadcast"
        ...
        self.PARENTAL_LOCK_ACT = "com.sony.dtv.tvsettings.parentalcontrolsetting.activities.ParentalLockActivity"
