...
class SampleTkinterLoop:
    ...
    def __init__(self, tkRoot):
        ...
        self.tkRoot = tkRoot
        self.tkRoot.title("Template")  # Change title for each test
    ...
    def startApp(self):
        ...
        # intruction below
        Label(self.sideFrame, text=f'Rewind Content for 3 seconds',
              font=self.sideFont, anchor='w').pack(fill=X, padx=10)
        Label(self.sideFrame, text=f'Play Content for 5 seconds',
              font=self.sideFont, anchor='w').pack(fill=X, padx=10)
        Label(self.sideFrame, text=f'Fast Forward Content for 3 seconds',
              font=self.sideFont, anchor='w').pack(fill=X, padx=10)
...
# Function Template ---------------------------------------------------------------------
    ...
    def play(self):
        ...
        if not self.stopLoop:
            ...
            # Create label
            x = Label(
                self.testFrame, text=f'{ts} - Play content',
                background=self.bgChooser(),
                foreground="#a5120d",
                font=self.boldFont, anchor='w')
            x.pack(fill=X)
